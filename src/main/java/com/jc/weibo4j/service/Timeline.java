...
import com.jc.weibo4j.http.ImageItem;
import com.jc.weibo4j.domain.Emotion;
import com.jc.weibo4j.domain.Paging;
...
public class Timeline extends Weibo{
	...
	public StatusWapper getUserTimeline(int count,int page) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json",new PostParameter[]{
			new PostParameter("count", count),
	...
	/**
     * created by JevonCode
     * get weibo by Count and Page
     * and reference JcUser
	*/
	public StatusWapper getUserTimeline(int count,int page,JcUser jcUser) throws WeiboException{
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL")+"statuses/user_timeline.json",new PostParameter[]{
			new PostParameter("count",count),
			new PostParameter("page",page)
